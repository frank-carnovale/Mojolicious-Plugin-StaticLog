# This Makefile is for the Mojolicious::Plugin::StaticLog extension to perl.
#
...
#     AUTHOR => [q[Frank Carnovale <frankc@cpan.org>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[Mojolicious::Plugin::StaticLog]
#     PREREQ_PM => { Mojolicious=>q[6.44] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Mojolicious/Plugin/StaticLog.pm]
#     test => { TESTS=>q[t/*.t] }
...
NAME_SYM = Mojolicious_Plugin_StaticLog
VERSION = 0.01
...
MAKE = make
FULLEXT = Mojolicious/Plugin/StaticLog
BASEEXT = StaticLog
PARENT_NAME = Mojolicious::Plugin
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Mojolicious/Plugin/StaticLog.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Mojolicious/Plugin
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Mojolicious/Plugin
...
TO_INST_PM = lib/Mojolicious/Plugin/StaticLog.pm

PM_TO_BLIB = lib/Mojolicious/Plugin/StaticLog.pm \
...
DISTNAME = Mojolicious-Plugin-StaticLog
DISTVNAME = Mojolicious-Plugin-StaticLog-0.01
...
manifypods : pure_all  \
	lib/Mojolicious/Plugin/StaticLog.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Mojolicious/Plugin/StaticLog.pm $(INST_MAN3DIR)/Mojolicious::Plugin::StaticLog.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '  - '\''Frank Carnovale <frankc@cpan.org>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Mojolicious-Plugin-StaticLog' >> META_new.yml
	$(NOECHO) $(ECHO) 'no_index:' >> META_new.yml
	$(NOECHO) $(ECHO) '  directory:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - t' >> META_new.yml
	$(NOECHO) $(ECHO) '    - inc' >> META_new.yml
	$(NOECHO) $(ECHO) 'requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '  Mojolicious: 6.44' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '      "Frank Carnovale <frankc@cpan.org>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Mojolicious-Plugin-StaticLog",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '         "requires" : {' >> META_new.json
	$(NOECHO) $(ECHO) '            "Mojolicious" : "6.44"' >> META_new.json
	$(NOECHO) $(ECHO) '         }' >> META_new.json
	$(NOECHO) $(ECHO) '      }' >> META_new.json
	$(NOECHO) $(ECHO) '   },' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Frank Carnovale &lt;frankc@cpan.org&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Mojolicious::" VERSION="6.44" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Mojolicious/Plugin/StaticLog.pm blib/lib/Mojolicious/Plugin/StaticLog.pm 
